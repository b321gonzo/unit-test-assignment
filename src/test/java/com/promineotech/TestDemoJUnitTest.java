...
class TestDemoJUnitTest {
	...
	//testing addPositive from TestDemo
	@ParameterizedTest
	...
	//testing multiplyNegative from TestDemo
	@ParameterizedTest
	...
	static Stream<Arguments> argumentsForMultiplyNegative() {
		// @formatter:off
		return Stream.of(
				//next line's parameters indicate that it won't throw an exception
				arguments(-2, -4, 8, false),
				//the following lines indicate they will throw an exception due to illegal arguments
